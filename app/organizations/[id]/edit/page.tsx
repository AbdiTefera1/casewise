...
import { useUpdateOrganization, useOrganization } from '@/hooks/useOrganization';
import { useState, useCallback, useEffect } from 'react';
import Image from 'next/image';
import { useRouter, useParams } from 'next/navigation';
import { UpdateOrganizationData } from '@/lib/api/organizations';
...
export default function EditOrganizationForm() {
  ...
  if (isLoading) return <div className="text-center p-8">Loading organization data...</div>;
  if (error) return <div className="text-center p-8 text-red-500">Error loading organization: {error.message}</div>;

  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Edit Organization</h2>
